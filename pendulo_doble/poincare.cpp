...
int main(){
    ...
    double H; //Hamiltoniano (E=1,3,5,10,15)
    //-------------------------------------------------------------------------------------
    ...
    //Para O1 y dO1
    //dO1=sqrt(H-2*g*(1-cos(y[0]))-g*(1-cos(y[1])));
    //dO2=0.0;
    //Para O2 y dO2
    dO1=0.0;
    dO2=sqrt(2*H-4*g*(1-cos(y[0]))-g*(1-cos(y[1])));    
    //-------------------------------------------------------------------------------------

    //-------------------------------RUNGE_KUTTA-------------------------------------------
    //Hacemos la primera iteración del algoritmo Runge-Kutta
    //Evaluamos k1
    k1[0]=h*dO1;
    k1[1]=h*dO2;
    ...
    ofstream poin;
    poin.open("poincare2.dat");
    for (int i = 1; i < iter; i++)
    {
        poin << y[0] << ", " << f0(y[0], y[1], y[2], y[3]) << endl;
        poin << endl;
